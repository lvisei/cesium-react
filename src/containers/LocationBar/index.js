  ...
  render() {
    ...
    return (
      <div className={this._className}>
        <div>
          {height ? (
            <span className={styles.locationcamera}>视点高：{height}米</span>
          ) : null}
          ...
          {elevation ? (
            <span className={styles.locationcamera}>海拔：{elevation}米</span>
          ) : null}
          {long ? (
            <span className={styles.locationcamera}>经度：{long}</span>
          ) : null}
          {lat ? (
            <span className={styles.locationcamera}>纬度：{lat}</span>
          ) : null}
        </div>
